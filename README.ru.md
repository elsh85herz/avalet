...
- **Логи и замеры времени** пишутся в `~/Library/Logs/Avalet/avalet.log` (только время и ошибки, без текста встреч, экрана и ключей). Приложите его, когда пишете о медленной работе.
