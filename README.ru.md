...
6. Запустите Avalet и пройдите настройку: разрешите **Микрофон** и **Запись экрана** (через запись экрана macOS разрешает захват звука собеседника), выберите свой ключ или Avalet и скачайте рекомендуемую модель распознавания (около 0,5 ГБ, один раз, с Hugging Face). Другие модели (medium, turbo) можно скачать, выбрать и удалить позже в Настройках, в простом и в расширенном режиме.
